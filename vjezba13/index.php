...
<body>
	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
		...
		if(!empty($_SESSION['news_title_1'])){echo $_SESSION['news_title_1'] . '<br>';}
		if(!empty($_SESSION['news_title_2'])){echo $_SESSION['news_title_2'] . '<br>';}
		if(!empty($_SESSION['news_title_3'])){echo $_SESSION['news_title_3'] . '<br>';}
		print '
		</aside>';
	}
	print '
